...
def write_read_check_tfrecords(project_dir, data_path, output_path):
    ...
    print("Started the reading of tfrecords")
...
def test_tfrecords_setup(project_dir):

    """A small function to test writing and reading a tfrecod file"""

    pathlib.Path(os.path.join(project_dir, 'data/processed/tfrecords-testing/train')).mkdir(parents=True, exist_ok=True)
    pathlib.Path(os.path.join(project_dir, 'data/processed/tfrecords-testing/test')).mkdir(parents=True, exist_ok=True)
    pathlib.Path(os.path.join(project_dir, 'data/processed/tfrecords-testing/validation')).mkdir(parents=True,exist_ok=True)

    train_data_path = 'data/train'
    train_output_path = 'data/processed/tfrecords-testing/train/train.tfrecord'
    write_read_check_tfrecords(project_dir, train_data_path, train_output_path)

    test_data_path = 'data/validation'
    test_output_path = 'data/processed/tfrecords-testing/validation/validation.tfrecord'
    write_read_check_tfrecords(project_dir, test_data_path, test_output_path)
...
if __name__ == '__main__':
    ...
    test_tfrecords_setup(project_dir)
